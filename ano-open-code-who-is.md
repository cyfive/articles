...
**Ростелеком** - единственный известный мне СПО проект [Reindexer](https://github.com/Restream/reindexer) - встраиваемая in-memory документ-ориентированная база данных. Знаю только потому, что когда работал с Эльбрусами в РТК ИТ, коллега портировал Reindexer на Эльбрус.
...
**РСХБ-ИНТЕХ** — есть в учредителях на главной странице, но нет в соответствующем разделе. Единственная связь с СПО - стратегия РоссельхозБанка, в которой говорится об использовании opensource продуктов, про вклад там ни слова.
...
![](/images/88f65cb9-08ba-4ef0-92d2-ccbff9725acf.png)
...
![](/images/db0be175-1789-4cb9-b3be-0711d795ae74.png)
...
![](/images/7dcf52a3-258f-445c-9283-2cb1021cee5e.png)
