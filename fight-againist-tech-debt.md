...
3. Низкая квалификация и отсутствие мотивации ее повышать у сотрудников. Если в вашей команде девиз "И так сойдет", то у меня для вас плохие новости: вы постоянно будете выплачивать технический долг. Если ваши разработчики не поднимают вопроса выплаты технического долга, то это тоже плохой сигнал.

## Как с ним бороться?

Если у вас выстроена работа с техническим долгом, то он для вас не будет проблемой. Рассмотрим несколько вариантов работы с техническим долгом:
...
2. Заведите нефункциональный бэклог, владельцем которого является технический топ-менеджер (например CTO). Вкупе с п. 1 это позволит вам сократить бесконтрольный рост технического долга.
