...
Всё, что написано ниже, работает при условии, что у вас на рабочем ПК стоит линукс, и СИБ согласовала вам доступ до него по 22 порту. Также на вашем рабочем ПК должен работать sshd.

Для удобства работы настройте аутентификацию на своём рабочем ПК через ключи. Для этого нужно сгенерировать новые ключи (если их у вас еще нет) командой:
